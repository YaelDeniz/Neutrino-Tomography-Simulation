...
TH2D*  GetObsEvents2Dcth(){  
    ...
    std::cout << "TrueVariable | E=[ " << EtrueMin << " , " << EtrueMax << " ] Zenith= [" << thtrueMin*180.0/TMath::Pi() << " , " << thtrueMax*180.0/TMath::Pi() << "]" << std::endl;
    std::cout << "RecoVariable | E=[ " << ErecoMin << " , " << ErecoMax << " ] Zenith= [" << threcoMin*180.0/TMath::Pi() << " , " << threcoMax*180.0/TMath::Pi() << "]" << std::endl;
    ...
    TrueSimulation.ThePileHeight = ThePileHight; // LLVP mas height 
    TrueSimulation.ThePileAperture=ThePileAperture; //Aperture
    TrueSimulation.PileDensityContrast = ThePileDensityContrast;
    TrueSimulation.PileChemContrast = ThePileChemContrast;

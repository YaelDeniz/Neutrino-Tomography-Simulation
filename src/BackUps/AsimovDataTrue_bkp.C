...
//Histrogram--------------------------------------------------------------------------------------------------------------------
     ...
     //InteractingRates2D = new TH2D("InteractingRates2D","Interacting Rate Histrogram", ibins,cthmin,cthmax,kbins,Emin,Emax); //binning in cth 
    ...
    double l,d,z,ly;
        ...
        {    
            ...
            { 
                ...
                std::cout << "************************************************************************************************************************************************Detector" << Rdet[2] << std::endl;
                std::cout << PremTable  <<std::endl;
                std::cout << HondaTable  <<std::endl;
                std::cout <<  PileHeight << " " << aperture << " " << AnomalyShape <<  " " << PileDensityContrast <<std::endl;

                std::cout << Emin <<  " " <<  Emax << " " << cthmin << " " << cthmax << " "<< ZenMin << " " << ZenMax <<  std::endl;


                std::cout << i << " " <<  k << " " << ibins << " " << kbins <<  "*** The value" << N_ik << " " <<  NnT*(Ri_nu + Ri_nubar)<< " " << dcth << " " << dphi << " " << dE  << " *** " << std::endl;

                //InteractingRates2D->SetBinContent(i,k,Ri_e);
            
                TrueHist->SetBinContent(i,k, NnT*(Ri_nu)*(dE*dcth*dphi) ); //Create histogram for  kth Pseudo-Experimens

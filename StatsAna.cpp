...
int main()
{
    ...
    int Tbins =3; // # of Bins of cosThetaZ
    ...
    // Loop for different values of drho_dp

    double drho_arr [7] = {-1.25 ,-1.0 ,-0.5 , 0.0 , 0.5 , 1.0, 1.25};
    //double drho_arr [1] = {1.0};
    int n =  sizeof(drho_arr) / sizeof(double);
    ...
    //Path2Original = "home/dehy0499/OscProb/PremTables/prem_default.txt";
    //Path2Original = "prem_default.txt";
    ...
    for (int i = 0; i < n; ++i)
    {
            ...
            //double drho_dp = -2+i*drho; // % difference

            double drho_dp = drho_arr[i];
            ...
            ChiSqrtVals << drho_dp << " " << dChi2 <<" "<< Ebins <<" "<< Tbins <<"\n";
